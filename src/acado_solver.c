...
state[9] = acadoVariables.od[lRun1 * 3];
state[10] = acadoVariables.od[lRun1 * 3 + 1];
state[11] = acadoVariables.od[lRun1 * 3 + 2];
...
acadoWorkspace.objValueIn[3] = acadoVariables.od[runObj * 3];
acadoWorkspace.objValueIn[4] = acadoVariables.od[runObj * 3 + 1];
acadoWorkspace.objValueIn[5] = acadoVariables.od[runObj * 3 + 2];
...
acadoWorkspace.objValueIn[2] = acadoVariables.od[60];
acadoWorkspace.objValueIn[3] = acadoVariables.od[61];
acadoWorkspace.objValueIn[4] = acadoVariables.od[62];
...
state[9] = acadoVariables.od[index * 3];
state[10] = acadoVariables.od[index * 3 + 1];
state[11] = acadoVariables.od[index * 3 + 2];
...
state[9] = acadoVariables.od[60];
state[10] = acadoVariables.od[61];
state[11] = acadoVariables.od[62];
...
acadoWorkspace.objValueIn[3] = acadoVariables.od[lRun1 * 3];
acadoWorkspace.objValueIn[4] = acadoVariables.od[lRun1 * 3 + 1];
acadoWorkspace.objValueIn[5] = acadoVariables.od[lRun1 * 3 + 2];
